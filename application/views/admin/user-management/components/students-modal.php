            ...
            <div class="modal-body">
                <form id="updateStudentForm" class="needs-validation" novalidate>
                    ...
                    <div class="alert alert-info" role="alert">
                        ...
                        <p>The following address are assigned to this user: </p>
                    ...
                    <div class="mb-3">
                        ...
                        <select id="edit_region" class="form-control" name="edit_region">
                            <option selected disabled value="">Select Region</option>
                        </select>
                    </div>
                    <div class="mb-3">
                        <label for="edit_province" class="form-label">Province</label>
                        <select id="edit_province" class="form-control" name="edit_province">
                            <option selected disabled value="">Select Province</option>
                        </select>
                    </div>
                    <div class="mb-3">
                        <label for="edit_municipality" class="form-label">City/Municipality</label>
                        <select id="edit_municipality" class="form-control" name="edit_municipality">
                            <option selected disabled value="">Select City/Municipality</option>
                        </select>
                    </div>
                    <div class="mb-3">
                        <label for="edit_barangay" class="form-label">Barangay</label>
                        <select id="edit_barangay" class="form-control" name="edit_barangay">
                            <option selected disabled value="">Select Barangay</option>
                        </select>
                    </div>
                    <div class="text-end">
