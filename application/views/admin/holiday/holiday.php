            ...
            <div class="card mb-0">
                <div class="card">
                    <div class="card-header d-flex">
                        <h5 class="card-title mb-0 flex-grow-1" id="holiday_label">Add New Holiday for Calendar Control</h5>
                    </div>
                    ...
                    <div class="card-body justify-content-center text-center">
                        ...
                        <form id="addHolidayForm" class="needs-validation" novalidate>
                            ...
                            <input type="hidden" class="form-control" id="holiday_id" name="holiday_id">
                                <div class="col-sm">
                            ...
                            <button type="button" onclick="return gotoAdd()" class="btn btn-danger waves-effect waves-light mt-2 mb-3" data-bs-toggle="collapse" href="#collapseExample" aria-expanded="true" aria-controls="collapseExample">Cancel</button>
                        </form>
                    </div>
                </div>
            </div>
